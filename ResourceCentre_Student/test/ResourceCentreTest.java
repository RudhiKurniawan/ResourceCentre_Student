...
public class ResourceCentreTest {
	...
	public void setUp() throws Exception {
		...
		cb1 = new Chromebook("CB0011", "ASUS Chromebook", "Win 10");
		cb2 = new Chromebook("CB0012", "HP Chromebook", "Win 10");
	...
	public void testDoReturnCamcorder() {
		//fail("Not yet implemented");
		// write your code here
		assertNotNull("Check if there valid Camcorder arraylist to add to", camcorderList);
		ResourceCentre.addCamcorder(camcorderList, cc1);
	...
	public void testDoReturnChromebook() {
		//fail("Not yet implemented");
		// write your code here
		assertNotNull("Check if there valid Chromebook arraylist to add to", chromebookList);
		ResourceCentre.addChromebook(chromebookList, cb1);
